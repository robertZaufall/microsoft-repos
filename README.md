...
`microsoft-repos` is a small static catalog of active Microsoft GitHub
repositories. It groups public Microsoft repositories into rough technology
clusters and keeps GitHub metadata fresh with a scheduled update script.
...
- `favicon.svg` - Microsoft-themed favicon.
