#!/usr/bin/env python3
"""
Build and refresh the Microsoft GitHub repository catalog.

The script fetches public GitHub metadata for Microsoft repositories that were
updated in the last three months and have more than 200 stars, groups them into
technology clusters, and rewrites index.html.
...
USER_AGENT = "microsoft-repos-catalog"
...
CLUSTERS: tuple[Cluster, ...] = (
    Cluster(
        ...
        "Editors, terminals, CLIs, debugging tools, package managers, and productivity utilities.",
        "blue",
        (
            "cli",
            "debug",
    ...
    Cluster(
        "dotnet-runtimes",
        ".NET, Languages & Runtimes",
        "Frameworks, compilers, runtimes, SDKs, and language ecosystems with Microsoft stewardship.",
        "purple",
        (
            ".net",
            "asp.net",
    ...
    Cluster(
        ...
        "Azure SDKs, cloud infrastructure, distributed systems, orchestration, and service platforms.",
        "cyan",
        (
            "azure",
            "bicep",
    ...
    Cluster(
        ...
        "AI frameworks, model tooling, data systems, analytics, database engines, and research code.",
        "green",
        (
            "agent",
            "ai",
    ...
    Cluster(
        ...
        "Browser-facing frameworks, React and Node tooling, Fluent UI, docs sites, and web platforms.",
        "yellow",
        (
            "css",
            "docs",
    ...
    Cluster(
        ...
        "Windows platform code, desktop applications, device tooling, WSL, shell, and native UI.",
        "orange",
        (
            "desktop",
            "device",
    ...
    Cluster(
        ...
        "Authentication, identity, authorization, security tooling, privacy, and compliance projects.",
        "red",
        (
            "auth",
            "authentication",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Update Microsoft GitHub repository catalog.")
...
def cluster_repo(repo: dict[str, Any]) -> Cluster:
    ...
    name_overrides = {
        ...
        "generative-ai-for-beginners": "ai-data",
        "jericho": "ai-data",
...
<title>Microsoft GitHub Repository Atlas</title>
...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  body {{
    ...
    min-height: 100vh;
    background:
      radial-gradient(circle at 85% -10%, rgba(0, 164, 239, 0.2), transparent 28rem),
      radial-gradient(circle at 8% 4%, rgba(127, 186, 0, 0.12), transparent 26rem),
  ...
  .logo-box {{
    ...
    color: #ffffff;
    font-weight: 800;
    box-shadow: 0 0 24px rgba(0, 164, 239, 0.28);
  }}
  ...
  .jump-group-clusters a {{
    border-color: rgba(0, 164, 239, 0.34);
  ...
  .search-panel {{
    ...
    border-radius: 12px;
    background:
      radial-gradient(circle at top right, rgba(0, 164, 239, 0.14), transparent 24rem),
  ...
  .search-input:focus {{
    border-color: rgba(0, 164, 239, 0.82);
    box-shadow: 0 0 0 3px rgba(0, 164, 239, 0.14);
  }}
  ...
  tbody tr:hover {{ background: rgba(0, 164, 239, 0.045); }}
  ...
  .activity-bar span {{
    ...
    background: linear-gradient(90deg, var(--microsoft), var(--green), var(--yellow));
  }}
  ...
  .footer a {{ color: var(--microsoft); text-decoration: none; }}
...
<body>
  <header class="header page-header">
    <h1 class="page-title"><span class="logo-box">MS</span>Microsoft GitHub Repository Atlas</h1>
    <p>Searchable snapshot of public Microsoft repositories from <a href="https://github.com/orgs/microsoft/repositories" target="_blank" rel="noreferrer">github.com/microsoft</a>. Included repositories have more than 200 stars and a commit within the last three months, since {cutoff}.</p>
...
{extra_section_html}
  ...
  <footer class="footer">
    <p style="margin-bottom: 10px;">Useful links:
      <a class="gh-link" href="https://learn.microsoft.com/" target="_blank" rel="noreferrer" style="display: inline; margin-left: 6px;">Microsoft Learn</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://azure.microsoft.com/" target="_blank" rel="noreferrer" style="display: inline;">Azure</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://code.visualstudio.com/" target="_blank" rel="noreferrer" style="display: inline;">VS Code</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://dotnet.microsoft.com/" target="_blank" rel="noreferrer" style="display: inline;">.NET</a>
    </p>
...
def main() -> int:
    ...
    print(f"Wrote {args.file} with {len(repos)} Microsoft repositories")
